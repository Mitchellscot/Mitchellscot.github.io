    ...
    <footer className={styles.container}>
      ...
      <div className={styles.socialLinks}>
        <Link href="https://www.strava.com/athletes/mitchellscot" passHref>
          <a target="_blank">
            <Image src="/strava.svg" height="50" width="50" alt="" />
          </a>
        </Link>

        <Link href="https://twitter.com/_mitchellscot" passHref>
          <a target="_blank">
            <Image src="/twitter.svg" height="50" width="50" alt="" />
          </a>
        </Link>
        <Link href="https://www.linkedin.com/in/mitchellscot" passHref>
          <a target="_blank">
            <Image src="/linkedIn.svg" height="50" width="50" alt="" />
          </a>
        </Link>
        <Link href="https://github.com/Mitchellscot" passHref>
          <a target="_blank">
            <Image src="/github.svg" height="50" width="50" alt="" />
          </a>
        </Link>
      </div>
    </footer>
